...
const navLinks: { href: Route<string>; label: string }[] = [
  { href: "/meet" as Route<string>, label: "Meet the Board" },
  { href: "/sponsors" as Route<string>, label: "Sponsors" },
  { href: "/events" as Route<string>, label: "Events" },
  { href: "/school" as Route<string>, label: "Sunday School" },
  { href: "/gallery" as Route<string>, label: "Gallery" },
  { href: "/contact" as Route<string>, label: "Contact" },
];
